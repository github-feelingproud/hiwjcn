...
namespace Lib.autofac
{
    ...
    public class AutofacIocContext : IDisposable
    {
        ...
        /// 再更高层添加数据
        /// </summary>
        private readonly List<IAutofacDependencyRegistrar> ExtraRegistrars = new List<IAutofacDependencyRegistrar>();
        ...
        public AutofacIocContext AddExtraRegistrar(IAutofacDependencyRegistrar reg)
        {
